...
tr_sizes = seq(1000, nrow(tr_dat), length.out=1000)
for (tr_size in tr_sizes) {
  tr_dat1 = tr_dat[1:tr_size,]
  tr_actual = tr_dat1$DeniedApproved
  fit = naiveBayes(DeniedApproved ~ Claim.Amount + Close.Amount + Airport.Name + Airline.Name, data=tr_dat1)
...
```{r}
plot(tr_errs, main="Learning Curve for Naive Bayes Approval/Denial - Model 1", xlab="Training Set Size", ylab="Error", ylim=c(0.15,0.4), col="red", type="l")
lines(te_errs, col="blue", type="l")
legend(1.6, 0.4, c("Training Set Error", "Test Set Error"), fill=c("red", "blue"))
```
...
```{r}
plot(tr_errs, main="Learning Curve for Naive Bayes Approval/Denial - Model 2", xlab="Training Set Size", ylab="Error", ylim=c(0.15,0.4), col="red", type="l")
lines(te_errs, col="blue", type="l")
legend(1.6, 0.4, c("Training Set Error", "Test Set Error"), fill=c("red", "blue"))
```
...
>>>>>>> 21f0f6854161c263157aad349222b933bf5fe99c
