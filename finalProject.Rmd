...
badRows1 = c(186743,97232,145145,186744,195600)
badRows2 = dat$Status == "Insufficient; one of the following items required: sum certain; statement of fact; signature; location of incident; and date."
dat = dat[-badRows1,]
dat = dat[-badRows2,]
```
...
levels(dat$Date.Received)[levels(dat$Date.Received) %in% c('')] <- 'N/A'
levels(dat$Airport.Name)[levels(dat$Airport.Name) %in% c('-','')] <- 'N/A'
