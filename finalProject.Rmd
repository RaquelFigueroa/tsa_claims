...
takeOut = dat$Status == "In litigation" | dat$Status == "In review" | dat$Status == "Claim has been assigned for further investigation"  | dat$Status == "Claim entered" | dat$Status == "Pending response from claimant" | dat$Status ==  "Closed as a contractor claim"
dat = dat[-takeOut,]
isNA = is.na(dat$Close.Amount)
dat = dat[-isNA,]


=======
>>>>>>> c430320a7386a36f395ebbe6daaaca7db2b19bbf
...
dat = dat[dat$Airport.Name != "",]
dat = dat[dat$Claim.Amount != "" & dat$Claim.Amount != "-",]
dat = dat[dat$Incident.Date != "",]
dat = dat[dat$Airline.Name != "",]
```
